package com.orkun.weathermicroservices.controller;

import com.orkun.weathermicroservices.dto.WeatherDto;
import com.orkun.weathermicroservices.exception.GeneralExceptionAdvice;
import com.orkun.weathermicroservices.service.WeatherService;
...
import static com.orkun.weathermicroservices.utils.TestSupport.formatter;
...
public class WeatherControllerTest {
    ...
    public void testGetWeather_whenCityParameterIsNotValid_shouldReturnHTTP400BadRequest() throws Exception {
        mockMvc.perform(get("/v1/api/open-weather/"+123)
