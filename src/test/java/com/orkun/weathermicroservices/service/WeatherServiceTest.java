package com.orkun.weathermicroservices.service;
...
import com.orkun.weathermicroservices.constant.Constants;
import com.orkun.weathermicroservices.dto.WeatherDto;
import com.orkun.weathermicroservices.dto.WeatherResponse;
import com.orkun.weathermicroservices.exception.ErrorResponse;
import com.orkun.weathermicroservices.exception.WeatherStackApiException;
import com.orkun.weathermicroservices.model.WeatherEntity;
import com.orkun.weathermicroservices.repository.WeatherRepository;
import com.orkun.weathermicroservices.utils.TestSupport;
...
public class WeatherServiceTest extends TestSupport {
    ...
    @Test
    public void testGetWeather_whenFirstRequestForRequestedCity_shouldCallWeatherStackAPIAndSaveResponseAndReturnWeatherDto()
            throws Exception{
        ...
        WeatherDto expected = new WeatherDto(savedEntity.getCityName(), savedEntity.getCountry(),
                savedEntity.getTemperature(), savedEntity.getUpdatedTime());
